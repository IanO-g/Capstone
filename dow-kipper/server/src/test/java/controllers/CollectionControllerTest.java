...
class CollectionControllerTest {
    ...
    void testAddCollection() {
        ...
        ResponseEntity<Object> response = collectionController.addCollection(collection);
    ...
    void testUpdateCollection() {
        ...
        ResponseEntity<Object> response = collectionController.updateCollection(1L, collection);
