    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationConfiguration authConfig) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,
                        "/video-game", "/video-game/*").permitAll()
                .antMatchers(HttpMethod.POST, "/video-game").authenticated()
                .antMatchers(HttpMethod.PUT, "/video-game/*").authenticated()
                .antMatchers(HttpMethod.DELETE, "/video-game/*").hasAuthority("ADMIN")
                .antMatchers("/**").denyAll()
                .and()
